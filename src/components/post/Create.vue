        ...
        <div class="col-md-12 form-wrapper">
            ...
            <form id="create-post-form" @submit.prevent="createPost">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea cols="30" rows="5" id="body" v-model="body" name="body" class="form-control"></textarea>
                </div>
                <div>
                    <label for="author">Author</label>
                    <input type="text" id="author" v-model="author" name="author" class="form-control" placeholder="Enter Author">    
                </div>
